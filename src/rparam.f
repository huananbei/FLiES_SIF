...
!**********************************************  
     ...
     &     npproc, Nprod, num)
      ...
      real dif,wq,span(100),wl0,wls
      real th0,ph0,phi,th,ph
      real sinf0,cosf0,cosq0,sinq0
      real RF,RQ,d,spcf(400),spcq(400)
...
!**************************************************
     ...
     &     nwl, RF, RQ, npl, np, npproc,Nprod, nmix, atype,
     &     rtype, rfname, fname, d, spcf, spcq,
     &     tauref, ctauref, cbnz, ctnz, cflg, num)
!*************************************************
      implicit none
      include 'common.inc'
      include 'math.inc'
      ...
      integer nspc, np, npl(200), npproc, Nprod
      
      real d, wq, span, wls, wl0
      real ctauref,tauref
      real cbot, ctop,dum, wlsd, wl0d(4000)
      real spcf(400),spcq(400),spcdf(4000),spcdq(4000)
      real parF,parQ,swF,swQ,RF,RQ
...
!     these are the fault and tentative value and no physical meaning
         ...
         write(*,*) "imode: Integration mode 1:Monochro 2:PAR 3:SW"
         read(num,*) imode
